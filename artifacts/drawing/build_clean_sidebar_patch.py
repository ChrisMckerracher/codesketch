...
# 1. COMPLETELY WIPE RIGHT SIDEBAR ACROSS ALL LAYERS (740..1000)
for lay in ["right_panel", "toolbar", "journey_focus", "typography"]:
    draw_rect(lay, 740, 0, 260, 700, "#FFFFFF", opacity=1.0)

# 2. Base panel border line
draw_rect("right_panel", 740, 0, 1, 700, "#E2E8F0")

# 3. Header (y=0..46): Studio Title + Feedback Toggle + Export CTA + Collapse Toggle
...
print(f"Total commands in clean patch: {len(commands)}")
with open("/private/tmp/codesketch-designer-20260910-fresh/artifacts/drawing/clean_sidebar_patch.json", "w") as f:
